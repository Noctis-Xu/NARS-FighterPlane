...
UPDATE_NARS_EVENT = pygame.USEREVENT + 2
...
class PlaneGame:
    ...
    def __set_timer(self):
        ...
        pygame.time.set_timer(HERO_FIRE_EVENT, timer_fire)  # the frequency of firing
